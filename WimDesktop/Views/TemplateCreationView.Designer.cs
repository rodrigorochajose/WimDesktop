namespace WimDesktop.Views
{
    partial class TemplateCreationView
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.roundedTextBoxOrientation = new WimDesktop.Components.Rounded.RoundedTextBox();
            this.roundedTextBoxSelectedFrame = new WimDesktop.Components.Rounded.RoundedTextBox();
            this.buttonSaveTemplate = new WimDesktop.Components.Rounded.RoundedButton();
            this.buttonDeleteFrame = new WimDesktop.Components.Rounded.RoundedButton();
            this.buttonRotateRight = new WimDesktop.Components.Rounded.RoundedButton();
            this.buttonNewFrame = new WimDesktop.Components.Rounded.RoundedButton();
            this.buttonRotateLeft = new WimDesktop.Components.Rounded.RoundedButton();
