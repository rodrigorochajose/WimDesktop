    ...
    public partial class Initial : DbMigration
    {
        public override void Up()
        {
            ...
            Sql(@"CREATE TABLE EXAM_IMAGE (
					...
					CONSTRAINT EXAM_IMAGE_FK_E FOREIGN KEY (EXAM_ID) REFERENCES EXAM(ID) ON DELETE NO ACTION ON UPDATE NO ACTION,
					CONSTRAINT EXAM_IMAGE_FK_TF FOREIGN KEY (TEMPLATE_FRAME_ID) REFERENCES TEMPLATE_FRAME(ID) ON DELETE NO ACTION ON UPDATE NO ACTION
				);"
			);
